...
import { View, Image, ScrollView, Text, Dimensions, StyleSheet, Linking } from 'react-native';
        ...
        <View style={styles.scheduleContainer}>
          ...
          {!orphanage?.open_on_weekends && (
            <View style={[styles.scheduleItem, styles.scheduleItemRed]}>
              ...
              <Text style={[styles.scheduleText, styles.scheduleTextRed]}>Não atendemos em fins de semana</Text>
            </View>
          )}
        </View>
